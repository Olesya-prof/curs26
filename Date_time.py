...
#
# curr_date_str = datetime.now().strftime('%d.%m.%Y')# перевод из datetime в строку
...
# print(current_date .strftime('%A %d %B %y %x %X') )
#
# current_date = datetime.now()
# ('year = 2033, microsecond = 0')
...
#
# days_of_week = ['Пн','Вт','Ср','Чт','Пн','Сб','Вс']
