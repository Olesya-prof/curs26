...
root.geometry ('300x150+100+20')
frame = Frame (root )
frame.pack (pady=10) # в root можно использовать только pack
num1 = Entry (frame, width=2, font=('Arial',15), justify='center')
num1.grid(row=0, column=0) # в frame теперь можно использовать только gred
...
num2.grid(row=0, column=2) # в frame теперь можно использовать только gred
